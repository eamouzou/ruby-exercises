...
class SortByPatternTest < Minitest::Test
  ...
  def test_sort_alphabetically
    ...
    transformed = transformed.sort # how does it sort this? What happens in the block?
    # also, what's the difference between sort and sort_by?
    # why does words.sort return something different from words.sort_by?
    sorted = []
