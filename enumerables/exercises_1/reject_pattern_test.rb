...
class RejectPatternTest < Minitest::Test
  ...
  def test_remove_vowels
    ...
    letters.each do |letter|
      remaining << letter unless letter.count('aeiouy') != 0 #is there an easier way?
    end
  ...
  def test_remove_numbers
    ...
    elements.each do |element|
      # could do: not_numbers << element unless element.class == Float || element.class == Integer
      not_numbers << element unless element.to_i != 0
    end
