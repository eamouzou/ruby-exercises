...
class PirateTest < Minitest::Test
  ...
  def test_a_pirate_gets_100_booty_for_robbing_ships
    ...
    pirate.rob_ships
    # check that the pirate got 100 booty for each ship it robbed
    assert_equal 200, pirate.has_booty?
    # rob some ships
    pirate.rob_ships
    # check that the pirate got 100 booty for each ship it robbed
    assert_equal 300, pirate.has_booty?
    # rob some ships
    pirate.rob_ships
    # check that the pirate got 100 booty for each ship it robbed
    assert_equal 400, pirate.has_booty?
    # rob some ships
    pirate.rob_ships
    # check that the pirate got 100 booty for each ship it robbed
    assert_equal 500, pirate.has_booty?
    # rob some ships
    pirate.rob_ships
    # check that the pirate got 100 booty for each ship it robbed
    assert_equal 600, pirate.has_booty?
  end
