...
class NestedTest < MiniTest::Test
  ...
  def test_list_of_dishes_names_for_olive_garden
    ...
    #=======================
     dishes_names = stores[:olive_garden][:dishes].reduce([]) do |acc, dish_hash|
     acc << dish_hash[:name]
     acc
   end
    #=======================
  ...
  def test_list_of_employees_across_all_restaurants
    ...
    #=======================
     employee_names = stores.reduce([]) do |acc, rest_hash|
       rest_hash[1][:employees].each do |emp|
         acc << emp
       end
       acc
     end
  ...
  def test_list_of_all_ingredients_across_all_restaurants
    ...
    #=======================
     ingredients = stores.reduce([]) do |acc, rest_hash|
       rest_hash[1][:dishes].each do |dish|
  ...
  def test_full_menu_price_for_olive_garden
    ...
    #=======================
     full_menu_price = stores[:olive_garden][:dishes].reduce(0) do |acc, dish|
       acc += dish[:price]
       acc
     end
    #=======================
